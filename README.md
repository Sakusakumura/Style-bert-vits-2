...
### 2. Added Gradient Accumulation Steps
...
### 3. Added functionality to save/apply scheduler state dict
   Learning rate no longer resets when interrupting and resuming training (probably)

### 4. Changed scheduler from ExponentialLR to CosineAnnealingLR
